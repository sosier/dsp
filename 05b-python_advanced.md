...
Xie: [['PhD', 'Associate Professor', 'sxie@mail.med.upenn.edu'], ['PhD', 'Assistant Professor', 'dxie@upenn.edu']]
Propert: [['ScD', 'Professor', 'propert@mail.med.upenn.edu']]
```
...
>> 
```
('Russell', 'Shinohara'): ['', 'Assistant Professor', 'rshi@mail.med.upenn.edu']
